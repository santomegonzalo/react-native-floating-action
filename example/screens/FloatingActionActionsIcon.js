    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.container}>
          <Property
            propertyName="floatingIcon"
            propertyValue="18"
            defaultValue="8"
          />
          <FloatingAction
            actions={actions}
            floatingIcon={<Ionicons name="ios-american-football" size={32} color="green" />}
            floatingCloseIcon={<Ionicons name="ios-basketball" size={32} color="green" />}
            onPressItem={name => {
